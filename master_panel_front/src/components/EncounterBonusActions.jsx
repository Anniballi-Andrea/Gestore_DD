...
export default function EncounterBonusActions({ el, i }) {
        ...
        <>
            <div className="card card_home">
                ...
                <div className="card-body ">
                    <div className="div">
                        {/*el.bonusActions.length > 0 ? <div className="text-center mb-2 pb-2 border-bottom">
                            <span className="fw-bold fs-5">Azioni bonus:</span>
                        </div>
                            :
                            <div className="text-center mb-2 pb-2 border-bottom">
                                <span className="fw-bold fs-5">Azioni bonus non presenti!</span>
                            </div>*/
                        }

                        {
                            el.bonusActions && el.bonusActions.map((bonus) => (
                                <div key={bonus.id} className="border-bottom pb-2 mb-2">
                                    <span className="fw-bold">{bonus.name}: </span>
