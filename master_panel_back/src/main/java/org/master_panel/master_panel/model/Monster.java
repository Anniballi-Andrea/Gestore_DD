...
public class Monster {
    ...
    @OneToMany(mappedBy = "monster", cascade = { CascadeType.REMOVE })
    private List<LegendAction> legendActions;

    @NotNull(message = "l'iniziativa non può essere vuota")
    @Min(-5)
    @Max(15)
    ...
    public List<LegendAction> getLegendActions() {
        return this.legendActions;
    }

    public void setLegendActions(List<LegendAction> legendActions) {
    ...
    public String toString() {
        return String.format(
                ...
                skills, immunity,
                resistence, vulnerability, level, image);
    }
